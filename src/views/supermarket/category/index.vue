    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['supermarket:category:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['supermarket:category:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['supermarket:category:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['supermarket:category:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listCategory, getCategory, delCategory, addCategory, updateCategory } from "@/api/supermarket/category";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      const categoryName = row.categoryName || this.Name;
      this.$modal.confirm('是否确认删除商品分类为"' + categoryName + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('supermarket/category/export', {
        ...this.queryParams
